...
namespace JS.OpenAI.Demo.Migrations
{
    ...
    [Migration("20231014122734_update_abp7.4")]
    partial class updateabp74
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JS.Abp.OpenAI.Conversations.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("OpenAIConversations", (string)null);
                });

            modelBuilder.Entity("JS.Abp.OpenAI.Messages.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("OpenAIMessages", (string)null);
                });
            ...
            modelBuilder.Entity("JS.Abp.OpenAI.Messages.Message", b =>
                {
                    b.HasOne("JS.Abp.OpenAI.Conversations.Conversation", null)
                        .WithMany()
